...
set t_Co=256
let g:colors_name = "nord-light-brighter"
...
let s:const= "#1155A3"
let s:comment="#8995A0"
let s:lightcomment="#d1d1d1"
let s:func="#0D5C43"
let s:str="#50750E"
let s:type="#A74047"
let s:var="#1155A3"
...
exe 'hi DiffAdd guibg=NONE guifg=#bef6dc gui=bold'
exe 'hi DiffDelete guifg='s:bg2
exe 'hi DiffChange  guifg=#5b76ef guibg=NONE'
...
exe 'hi FloatBorder          guifg=#2f3336 guibg='s:bg
